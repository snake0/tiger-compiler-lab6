...
static const char *const yytname[] =
{
  ...
  "VAR", "TYPE", "SHIFT", "UMINUS", "$accept", "program", "exp", "lvalue",
  "rec", "nonempty_rec", "rec_one", "expseq", "single", "actuals",
  "nonempty_args", "tydec", "tydec_one", "ty", "tyfields", "fundec",
  "fundec_one", "nonempty_tyfields", "vardec", "decs", "nonempty_decs",
  "nonempty_decs_s", "seq", "seq_exps", YY_NULLPTR
};
#endif
